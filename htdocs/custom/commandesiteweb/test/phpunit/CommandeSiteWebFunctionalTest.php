...
/**
 * \file    test/phpunit/CommandeSiteWebFunctionalTest.php
...
/**
 * Class CommandeSiteWebFunctionalTest
 *
 ...
 *
 * @package Testcommandesiteweb
 */
class CommandeSiteWebFunctionalTest extends \PHPUnit_Extensions_Selenium2TestCase
{
	...
	public function testModuleEnabled()
	{
		...
		if (strstr($module_status_image->attribute('src'), 'switch_off.png')) {
			// Enable the module
			$this->byHref('modCommandeSiteWeb')->click();
		} else {
			// Disable the module
			$this->byHref('modCommandeSiteWeb')->click();
			// Reenable the module
	...
	{
		$this->url('/custom/commandesiteweb/admin/setup.php');
		$this->authenticate();
		return $this->assertContains('commandesiteweb/admin/setup.php', $this->url(), 'Configuration page');
	}
	...
	{
		$this->url('/custom/commandesiteweb/admin/about.php');
		$this->authenticate();
		return $this->assertContains('commandesiteweb/admin/about.php', $this->url(), 'About page');
	}
	...
	public function testBoxDeclared()
	{
		...
		$this->authenticate();
		return $this->assertContains('commandesitewebwidget1', $this->source(), "Box enabled");
	}
	...
	public function testTriggerDeclared()
	{
		...
		return $this->assertContains(
			'interface_99_modCommandeSiteWeb_CommandeSiteWebTriggers.class.php',
	...
	public function testTriggerEnabled()
	{
		...
		return $this->assertContains(
			'tick.png',
			$this->byXPath('//td[text()="interface_99_modCommandeSiteWeb_MyTrigger.class.php"]/following::img')->attribute('src'),
			"Trigger enabled"
		);
	}
